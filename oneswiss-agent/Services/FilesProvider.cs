...
public class FilesProvider
{
    ...
    private static string GetTechLogDefaultFolder()
        ...
        {
            PlatformID.Win32NT => Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.CommonApplicationData), "oneswiss-server", "techlog"),
            _ => Path.Combine("/var", "log", "oneswiss-server", "techlog")
        };
