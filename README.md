...
Кроссплатформенный программный комплекс, состоящий из агента (onecmonitor-agent) и сервера (onecmonitor).  
...
- Загрузка конфигурации - загрузка конфигурации CFE файлом
