...
{
    [Key(0)] [RacField("cluster")] public string Id { get; set; }
    ...
    [Key(6)] [RacField("lifetime-limit")] public int LifetimeLimit { get; set; }

    [Key(7)] [RacField("max-memory-size")] public int MaxMemorySize { get; set; }

    [Key(8)]
    [RacField("max-memory-time-limit")]
    public int MaxMemoryTimeLimit { get; set; }

    [Key(9)] [RacField("security-level")] public V8SecurityLevel SecurityLevel { get; set; }
    ...
    [Key(17)] public int RagentPort { get; set; }
}