...
public static class ChannelExtensions
{
    ...
    private static async Task<DesignerAgentMessage> EnsureNextType(this Channel<DesignerAgentMessage> channel, string type)
    {
    ...
    public static async Task<DesignerAgentMessage> EnsureNextSuccess(this Channel<DesignerAgentMessage> channel)
        => await channel.EnsureNextType("success");
