...
public class GetInfoRequest
{
    ...
    [JsonPropertyName("appStackHash")] public string? AppStackHash { get; set; }

    [JsonPropertyName("appVersion")] public string? AppVersion { get; set; }

    [JsonPropertyName("clientStackHash")] public string? ClientStackHash { get; set; }
    ...
    [JsonPropertyName("configVersion")] public string? ConfigVersion { get; set; }

    [JsonPropertyName("clientID")] public string? ClientId { get; set; }

    [JsonPropertyName("reportID")] public string? ReportId { get; set; }

    [JsonPropertyName("errorCategories")] public string[]? ErrorCategories { get; set; }
    ...
    [JsonPropertyName("serverStackHash")] public string? ServerStackHash { get; set; }

    [JsonPropertyName("systemCrash")] public bool? SystemCrash { get; set; }
}