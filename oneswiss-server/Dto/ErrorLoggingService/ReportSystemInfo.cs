...
public class ReportSystemInfo
{
    ...
    [JsonPropertyName("fullRAM")] public long FullRam { get; set; }

    [JsonPropertyName("freeRAM")] public long FreeRam { get; set; }

    [JsonPropertyName("processor")] public string Processor { get; set; } = string.Empty;
