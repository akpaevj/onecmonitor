...
namespace OneSwiss.Server.Migrations
{
    ...
    [Migration("20260909212121_AddRefreshTokenOAuthClientId")]
    partial class AddRefreshTokenOAuthClientId
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OneSwiss.Server.Models.EventLogExportItem", b =>
                {
                    ...
                    b.Property<DateTime?>("LastReducedUpTo")
                        .HasColumnType("timestamp with time zone");

                    b.Property<int>("ReduceKeepDays")
                        .HasColumnType("integer");

                    b.Property<bool>("ReduceSourceLog")
                        .HasColumnType("boolean");
            ...
            modelBuilder.Entity("OneSwiss.Server.Models.EventLogSettings", b =>
                {
                    ...
                    b.Property<bool>("ReductionEnabled")
                        .HasColumnType("boolean");

                    b.Property<int>("ReductionHourUtc")
                        .HasColumnType("integer");

                    b.Property<int>("ReductionSafetyMarginHours")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("OneSwiss.Server.Models.OAuthAuthorizationCode", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("OneSwiss.Server.Models.OAuthClient", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("OneSwiss.Server.Models.RefreshToken", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
