...
namespace OneSwiss.Server.Migrations
{
    ...
    [Migration("20250922192438_EventLogExportItems")]
    partial class EventLogExportItems
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OneSwiss.Server.Models.GitSyncTaskItem", b =>
                {
                    ...
                    b.Property<string>("BaseConfigurationRepositoryId")
                        .HasColumnType("TEXT");
                    ...
                    b.HasIndex("BaseConfigurationRepositoryId");
            ...
            modelBuilder.Entity("OneSwiss.Server.Models.GitSyncTaskItem", b =>
                {
                    b.HasOne("OneSwiss.Server.Models.ConfigurationRepository", "BaseConfigurationRepository")
                        .WithMany()
                    ...
                    b.Navigation("BaseConfigurationRepository");
                    ...
                    b.OwnsOne("OneSwiss.Server.Models.MaintenanceTasks.LoadExtensionStep", "LoadExtensionStep", b1 =>
                        {
                            ...
                            b1.Property<string>("BaseConfigurationRepositoryId")
                                .HasColumnType("TEXT");
