...
public class TjEvent
{
    ...
    [JsonProperty("props")] public Dictionary<string, string> Properties { get; set; } = [];

    [JsonProperty("_agent_id")] public Guid AgentId { get; set; } = Guid.Empty;

    [JsonProperty("_seance_id")] public Guid SeanceId { get; set; } = Guid.Empty;

    [JsonProperty("_template_id")] public Guid TemplateId { get; set; } = Guid.Empty;

    [JsonProperty("_fileName")] public string FileName { get; set; } = string.Empty;

    [JsonProperty("_end_position")] public long EndPosition { get; set; }
