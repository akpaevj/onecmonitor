...
public class MaintenanceStepDto
{
    ...
    [Key(7)]
    [ContextProperty("ШагКопированияИнформационнойБазы", "CopyInfoBaseStep",
        Converter = typeof(NullableConverter<CopyInfoBaseStepDto>))]
    public CopyInfoBaseStepDto? CopyInfoBaseStep { get; set; }

    [Key(8)]
    [ContextProperty("ШагУдаленияРасширения", "DeleteExtensionStep",
        Converter = typeof(NullableConverter<DeleteExtensionStepDto>))]
    public DeleteExtensionStepDto? DeleteExtensionStep { get; set; }

    [Key(9)]
    [ContextProperty("ШагИсполненияОскрипта", "ExecuteOneScriptStep",
        Converter = typeof(NullableConverter<ExecuteOneScriptStepDto>))]
    public ExecuteOneScriptStepDto? ExecuteOneScriptStep { get; set; }

    [Key(10)]
    [ContextProperty("ШагЗагрузкиКонфигурации", "LoadConfigurationStep",
        Converter = typeof(NullableConverter<LoadConfigurationStepDto>))]
    public LoadConfigurationStepDto? LoadConfigurationStep { get; set; }

    [Key(11)]
    [ContextProperty("ШагЗагрузкиРасширения", "LoadExtensionStep",
        Converter = typeof(NullableConverter<LoadExtensionStepDto>))]
    public LoadExtensionStepDto? LoadExtensionStep { get; set; }

    [Key(12)]
    [ContextProperty("ШагБлокировкиСоединений", "LockConnectionsStep",
        Converter = typeof(NullableConverter<LockConnectionsStepDto>))]
    public LockConnectionsStepDto? LockConnectionsStep { get; set; }

    [Key(13)]
    [ContextProperty("ШагЗапускаВнешнейОбработки", "StartExternalDataProcessorStep",
        Converter = typeof(NullableConverter<StartExternalDataProcessorStepDto>))]
    public StartExternalDataProcessorStepDto? StartExternalDataProcessorStep { get; set; }

    [Key(14)]
    [ContextProperty("ШагОбновленияКонфигурации", "UpdateConfigurationStep",
        Converter = typeof(NullableConverter<UpdateConfigurationStepDto>))]
